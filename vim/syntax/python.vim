...
"                                        enabled by default). Can also be set
"                                        as a buffer (b:python_version_2)
"                                        variable.
"
...
" <{[ Default options
"
call s:EnableByDefault("g:python_version_2")
...
if s:Python2Syntax()
    ...
    syn keyword pythonStatement nonlocal async await
...
syn keyword pythonBuiltinObj True False None Ellipsis NotImplemented
